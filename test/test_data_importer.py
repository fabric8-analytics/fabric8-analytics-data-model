...
def test_parse_int_or_none_for_float_input():
    ...
    assert 1 == parse_int_or_none(1.9)
    assert -1 == parse_int_or_none(-1)
...
def test_parse_int_or_none_for_string_input():
    ...
    assert 41 == parse_int_or_none("41.9")
    assert -42 == parse_int_or_none("-42")
    assert -42 == parse_int_or_none("-42.1")
    assert -41 == parse_int_or_none("-41.9")
...
def test_parse_int_or_none_for_unicode_string_input():
    ...
    assert 41 == parse_int_or_none(u"41.9")
    assert -42 == parse_int_or_none(u"-42")
    assert -42 == parse_int_or_none(u"-42.1")
    assert -41 == parse_int_or_none(u"-41.9")
...
def test_parse_int_or_none_for_invalid_input():
    ...
    assert parse_int_or_none(True) == 1
    assert parse_int_or_none(False) == 0
